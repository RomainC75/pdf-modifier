...
def select_rectangle_and_change_colors(img):
    ...
    secu_morphed = cv2.cvtColor(secu_rect, cv2.COLOR_BGR2HSV)
    # secu_morphed = cv2.Canny(secu_morphed,75,100)
    ...
    # secu_morphed = cv2.fastNlMeansDenoising(secu_morphed,None,10,10,7,21)
...
def extract_secu_as_string(emptypdf_name):
    ...
    # startP=(0,0)
    # endP=(50,50)
    # img = secu_morphed[startP[1]:endP[1], startP[0]:endP[0] ]
